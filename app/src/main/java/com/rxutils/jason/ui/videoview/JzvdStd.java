...
public class JzvdStd extends Jzvd {
    ...
    public void showWifiDialog() {
        ...
        builder.setPositiveButton(getResources().getString(R.string._not_wifi_confirm), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                JzvdStd.this.onEvent(JZUserActionStd.ON_CLICK_START_WIFIDIALOG);
                JzvdStd.this.startVideo();
                WIFI_TIP_DIALOG_SHOWED = true;
            }
        });
        builder.setNegativeButton(getResources().getString(R.string._not_wifi_cancel), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
